...
import os
IN_CSV = Path(os.environ.get("PRISMA_IN_CSV") or (OUTPUTS / "pdfs_still_missing_links.csv"))
OUT_DIR = Path(os.environ.get("PRISMA_PDF_DIR") or (WORKSPACE / "pdfs_oa_auto"))
OUT_DIR.mkdir(parents=True, exist_ok=True)
LOG_CSV = Path(os.environ.get("PRISMA_LOG_CSV") or (OUTPUTS / "pdfs_oa_auto_log.csv"))
