...
WORK = OUTPUTS
import os
IN_CSV = Path(os.environ.get("PRISMA_IN_CSV") or (OUTPUTS / "pdfs_missing.csv"))
OUT_CSV = Path(os.environ.get("PRISMA_OUT_CSV") or (OUTPUTS / "pdfs_still_missing_links.csv"))
